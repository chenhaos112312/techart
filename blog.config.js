...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'a2e1f95e1d6b457caf24354e00f3e96d',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Tech-Art', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xyehr.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'TechArt, Tech-Art', // 网站关键词 英文逗号隔开
  ...
  ALGOLIA_APP_ID: process.env.NEXT_PUBLIC_ALGOLIA_APP_ID || '8Q0603I0T3', // 在这里查看 https://dashboard.algolia.com/account/api-keys/
  ALGOLIA_ADMIN_APP_KEY: process.env.ALGOLIA_ADMIN_APP_KEY || '7903e22ec0eec373bf953ccde408544b', // 管理后台的KEY，不要暴露在代码中，在这里查看 https://dashboard.algolia.com/account/api-keys/
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-9467189236880428', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Protecting privacy from the root.', // 站点描述，被notion中的页面描述覆盖
